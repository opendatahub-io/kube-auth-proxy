...
func TestOpenShiftProviderWithoutJWTIssuersDoesNotRequireServiceAccountCA(t *testing.T) {
	o := testOptions()
	o.Providers[0].Type = providerTypeOpenShift

	err := Validate(o)
	assert.NoError(t, err)
}

func TestOpenShiftProviderWithSkipJwtBearerTokensButNoIssuers(t *testing.T) {
	o := testOptions()
	o.Providers[0].Type = providerTypeOpenShift
...
func TestOpenShiftProviderWithExplicitCAFilesSkipsServiceAccountCAAutoLoad(t *testing.T) {
...
func TestNonOpenShiftProviderDoesNotAutoLoadServiceAccountCA(t *testing.T) {
	o := testOptions()
	o.Providers[0].Type = "oidc"
	o.Providers[0].OIDCConfig.IssuerURL = "https://example.com"
	o.Providers[0].OIDCConfig.SkipDiscovery = true
	o.Providers[0].OIDCConfig.JwksURL = "https://example.com/.well-known/jwks.json"
